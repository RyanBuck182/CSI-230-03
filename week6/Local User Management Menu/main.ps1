...
while($operation){
    ...
    elseif($choice -eq 3){ 
        ...
        if ($chkUser -ne $true) {
            ...
            $password = Read-Host -AsSecureString -Prompt "Please enter a password for the new user"
            ...
            if ($chkPassword -ne $false) {
                ...
                Write-Host "Password should be more than 5 characters and include at least 1 letter, digit, and special character." | Out-String
            }
    ...
    elseif($choice -eq 9) {
        ...
        Write-Host "Please enter a number between 1 and 10."
    }
}